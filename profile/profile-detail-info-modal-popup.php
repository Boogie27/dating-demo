                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit_display_name_input" class="form-control" value="" placeholder="Display name">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" id="edit_age_input" class="form-control" value="" placeholder="Age">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="edit_date_of_birth_input" class="form-control" value="" placeholder="Date of birth">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <div class="alert-form alert_7 text-danger"></div>
                                    <input type="text" id="edit_city_input" class="form-control" value="" placeholder="City">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
                                    <div class="alert-form alert_8 text-danger"></div>
                                    <input type="text" id="edit_state_input" class="form-control" value="" placeholder="State">
                                </div>
                            </div>
